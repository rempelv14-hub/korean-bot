...
from aiogram.exceptions import TelegramBadRequest, TelegramForbidden, RetryAfter
...
if not BOT_TOKEN:
    ...
    BOT_TOKEN = None  # Чтобы бот не падал сразу
else:
    logging.info("✅ BOT_TOKEN найден!")
...
async def send_video(message: Message):
    ...
    except (TelegramBadRequest, TelegramForbidden, RetryAfter) as e:
...
async def start_bot():
    ...
    if bot:
        ...
        logging.error("❌ Bot не создан, токен не найден или неверный!")

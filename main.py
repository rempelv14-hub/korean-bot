...
async def send_video(message: Message):
    ...
    logging.info(f"[{message.from_user.id}] Отправлено видео")
...
async def send_pdf(message: Message):
    ...
    logging.info(f"[{message.from_user.id}] Отправлен PDF")
...
async def send_course_presentation(message: Message):
    ...
    logging.info(f"[{message.from_user.id}] Отправлена презентация курса")
...
async def send_useful_tips(message: Message):
    ...
    logging.info(f"[{message.from_user.id}] Отправлены полезные советы")
